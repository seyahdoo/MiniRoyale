...
public:
	...
	*/
	int getRequestType(char* buffer, const string &sourceAddress, const unsigned short &sourcePort, vector<PlayerInformation*>& players);

	/**
	*	If playerID of last added player is equal to playerID which is in the buffer then push_back() function was succesfull, return true
	*	else return false
	*/
	bool handleRequestTypeJoin(char* buffer, const string &sourceAddress, const unsigned short &sourcePort, vector<PlayerInformation*>& players);

	int handleRequestTypeSayy(char* buffer, const string &sourceAddress, const unsigned short &sourcePort, vector<PlayerInformation*>& players);

	int handleRequestTypePing(char* buffer, const string &sourceAddress, const unsigned short &sourcePort, vector<PlayerInformation*>& players);

	int handleRequestTypePong(char* buffer, const string &sourceAddress, const unsigned short &sourcePort, vector<PlayerInformation*>& players);

	int handleRequestTypeMove(char* buffer, const string &sourceAddress, const unsigned short &sourcePort, vector<PlayerInformation*>& players);
